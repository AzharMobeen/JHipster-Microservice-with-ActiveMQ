package com.az.task.config.timezone;

import com.az.task.AzTaskApp;
import com.az.task.repository.timezone.DateTimeWrapper;
import com.az.task.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = AzTaskApp.class)
