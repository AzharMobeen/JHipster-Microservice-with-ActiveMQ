...
public class StockLevelProcessorServiceIntegrationTest{			
	
	private static final Logger log = LoggerFactory.getLogger(StockLevelProcessorServiceIntegrationTest.class);
    ...
    public void consumerFromQueuesAndSendToTopic() {
        ...
        // With In three seconds. @JmsListener from StockLevelProcessorService will
        // consume message.
        try {
